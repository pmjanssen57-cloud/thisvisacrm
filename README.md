...
- Shortened the Enquiries & Intake page intro copy.
- Tidied the Enquiries & Intake form links so Contact, Assessment, and Seminar form buttons sit cleanly in one row on desktop.
- Shortened the public form button labels to reduce wrapping.
- No database migration required.

## Test process

1. Deploy this package to Netlify.
2. Open the CRM and confirm the top **Viewing** dropdown is styled consistently.
